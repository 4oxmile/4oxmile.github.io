...
const LEVELS_RAW = [
  ...
  // Level 10 - 4 boxes, 8x8 (4 boxes, 8x8)
  [
    '########',
    '#      #',
    '# @$.  #',
  ...
  // Level 21 - Easy-Medium (3 boxes, 7x7)
  [
    '#######',
    '##    #',
    '# . @##',
  ...
  // Level 22 - Easy-Medium (3 boxes, 8x7)
  [
    '########',
    '##     #',
    '##..   #',
  ...
  // Level 23 - Easy-Medium (3 boxes, 8x7)
  [
    '########',
    '##     #',
    '#   $@ #',
  ...
  // Level 24 - Easy-Medium (3 boxes, 8x8)
  [
    '########',
    '#      #',
    '#  @$. #',
  ...
  // Level 25 - Easy-Medium (3 boxes, 8x8)
  [
    '########',
    '#      #',
    '#   $# #',
  ...
  // Level 26 - Easy-Medium (3 boxes, 8x8)
  [
    '########',
    '#     ##',
    '#    @ #',
  ...
  // Level 27 - Easy-Medium (3 boxes, 8x8)
  [
    '########',
    '#      #',
    '#   .  #',
  ...
  // Level 28 - Easy-Medium (3 boxes, 8x8)
  [
    '########',
    '#      #',
    '#   .. #',
  ...
  // Level 29 - Easy-Medium (3 boxes, 8x8)
  [
    '########',
    '#      #',
    '# .$   #',
  ...
  // Level 30 - Easy-Medium (3 boxes, 8x8)
  [
    '########',
    '#      #',
    '#   @  #',
  ...
  // Level 41 - Medium-Hard (4 boxes, 9x8)
  [
    '#########',
    '#       #',
    '#  $. . #',
  ...
  // Level 42 - Medium-Hard (4 boxes, 10x8)
  [
    '##########',
    '#        #',
    '#  $.  $ #',
  ...
  // Level 43 - Medium-Hard (4 boxes, 10x8)
  [
    '##########',
    '#        #',
    '#     .  #',
  ...
  // Level 44 - Medium-Hard (4 boxes, 10x8)
  [
    '##########',
    '#        #',
    '#    $   #',
  ...
  // Level 45 - Medium-Hard (4 boxes, 10x8)
  [
    '##########',
    '#  #     #',
    '# .   .  #',
  ...
  // Level 46 - Medium-Hard (4 boxes, 10x8)
  [
    '##########',
    '#        #',
    '# $.     #',
  ...
  // Level 47 - Medium-Hard (4 boxes, 10x8)
  [
    '##########',
    '#        #',
    '#        #',
  ...
  // Level 48 - Medium-Hard (4 boxes, 10x8)
  [
    '##########',
    '#     #  #',
    '#    $   #',
  ...
  // Level 49 - Medium-Hard (4 boxes, 10x8)
  [
    '##########',
    '#        #',
    '#  @$    #',
  ...
  // Level 50 - Medium-Hard (4 boxes, 10x8)
  [
    '##########',
    '#        #',
    '#  .$$.  #',
  ...
  // Level 72 - Very Hard (5 boxes, 11x9)
  [
    '###########',
    '#@        #',
    '#   # $   #',
  ...
  // Level 73 - Very Hard (5 boxes, 11x9)
  [
    '###########',
    '#  @*     #',
    '#        $#',
  ...
  // Level 74 - Very Hard (5 boxes, 11x9)
  [
    '###########',
    '#         #',
    '#  $      #',
  ...
  // Level 75 - Very Hard (5 boxes, 11x9)
  [
    '###########',
    '#         #',
    '#         #',
  ...
  // Level 76 - Very Hard (5 boxes, 11x9)
  [
    '###########',
    '#      @  #',
    '#  *#    $#',
  ...
  // Level 77 - Very Hard (6 boxes, 12x9)
  [
    '############',
    '#   *      #',
    '#         *#',
  ...
  // Level 78 - Very Hard (6 boxes, 12x9)
  [
    '############',
    '#     . $  #',
    '# .$    $$ #',
  ...
  // Level 79 - Very Hard (6 boxes, 12x9)
  [
    '############',
    '#          #',
    '#  #* $.$  #',
  ...
  // Level 80 - Very Hard (6 boxes, 12x9)
  [
    '############',
    '#  . $ @   #',
    '#   ## *   #',
  ...
  // Level 81 - Very Hard (6 boxes, 12x9)
  [
    '############',
    '#  *  @    #',
    '#  * $     #',
  ...
  // Level 82 - Very Hard (6 boxes, 12x10)
  [
    '############',
    '# . * .    #',
    '#   $ $    #',
  ...
  // Level 83 - Very Hard (6 boxes, 12x10)
  [
    '############',
    '#          #',
    '#      *   #',
  ...
  // Level 84 - Very Hard (6 boxes, 12x10)
  [
    '############',
    '#  *       #',
    '#        # #',
  ...
  // Level 85 - Very Hard (6 boxes, 12x10)
  [
    '############',
    '#          #',
    '# $#$  #   #',
  ...
  // Level 86 - Very Hard (6 boxes, 12x10)
  [
    '############',
    '#          #',
    '#  #* *$ # #',
  ...
  // Level 87 - Very Hard (7 boxes, 12x10)
  [
    '############',
    '# *        #',
    '# $        #',
  ...
  // Level 88 - Very Hard (7 boxes, 12x10)
  [
    '############',
    '#          #',
    '#      *   #',
  ...
  // Level 89 - Very Hard (7 boxes, 12x10)
  [
    '############',
    '#   *      #',
    '#        $ #',
  ...
  // Level 90 - Very Hard (7 boxes, 12x10)
  [
    '############',
    '#        * #',
    '#  . @     #',
  ...
  // Level 91 - Very Hard (7 boxes, 12x10)
  [
    '############',
    '#          #',
    '#   *      #',
  ...
  // Level 100 - Expert (8 boxes, 12x11)
  [
    '############',
    '#    .     #',
    '#    $     #',
...
class Game {
  ...
  _showLevelSelect() {
    ...
    this.levels.forEach((_, i) => {
      ...
      if (isCurrent && !isCompleted && isUnlocked) card.classList.add('current');
