...
const LEVELS_RAW = [
  ...
  // Level 22 - Easy-Medium (3 boxes, 7x7)
  [
    '#######',
    '#     #',
    '#  $  #',
  ...
  // Level 24 - Easy-Medium (3 boxes, 8x7)
  [
    '########',
    '#      #',
    '#@   *.#',
  ...
  // Level 25 - Easy-Medium (3 boxes, 8x7)
  [
    '########',
    '#      #',
    '#  $ $.#',
  ...
  // Level 26 - Easy-Medium (3 boxes, 8x7)
  [
    '########',
    '#      #',
    '# $ .* #',
  ...
  // Level 41 - Medium-Hard (4 boxes, 9x7)
  [
    '#########',
    '#       #',
    '#* .$ $ #',
  ...
  // Level 42 - Medium-Hard (4 boxes, 9x7)
  [
    '#########',
    '#@$   . #',
    '# $. $ .#',
  ...
  // Level 43 - Medium-Hard (4 boxes, 9x8)
  [
    '#########',
    '#       #',
    '# .* .  #',
  ...
  // Level 44 - Medium-Hard (4 boxes, 9x8)
  [
    '#########',
    '#  @  . #',
    '# $  $  #',
  ...
  // Level 45 - Medium-Hard (4 boxes, 9x8)
  [
    '#########',
    '# $ .   #',
    '#@  .  *#',
  ...
  // Level 46 - Medium-Hard (4 boxes, 9x8)
  [
    '#########',
    '# .   $ #',
    '#@      #',
  ...
  // Level 47 - Medium-Hard (4 boxes, 9x8)
  [
    '#########',
    '#       #',
    '# *.   .#',
  ...
  // Level 48 - Medium-Hard (4 boxes, 10x7)
  [
    '##########',
    '# $ .    #',
    '# $.     #',
  ...
  // Level 49 - Medium-Hard (4 boxes, 10x7)
  [
    '##########',
    '#        #',
    '#      $ #',
  ...
  // Level 71 - Very Hard (5 boxes, 12x8)
  [
    '############',
    '#   .. @   #',
    '#        $$#',
  ...
  // Level 72 - Very Hard (5 boxes, 12x8)
  [
    '############',
    '#      *   #',
    '#$ $ $  .  #',
  ...
  // Level 73 - Very Hard (5 boxes, 12x9)
  [
    '############',
    '#         @#',
    '#          #',
  ...
  // Level 74 - Very Hard (6 boxes, 12x8)
  [
    '############',
    '#    *   * #',
    '#      . $ #',
  ...
  // Level 75 - Very Hard (6 boxes, 12x8)
  [
    '############',
    '#   $  .   #',
    '#.  * *    #',
  ...
  // Level 76 - Very Hard (6 boxes, 12x9)
  [
    '############',
    '#  .  $ @  #',
    '#   $      #',
  ...
  // Level 79 - Very Hard (6 boxes, 12x10)
  [
    '############',
    '#    @     #',
    '# $.$  .   #',
  ...
  // Level 80 - Very Hard (6 boxes, 12x10)
  [
    '############',
    '#  @       #',
    '# $   $ .* #',
  ...
  // Level 82 - Very Hard (6 boxes, 12x9)
  [
    '############',
    '#     .    #',
    '#          #',
  ...
  // Level 84 - Very Hard (7 boxes, 12x9)
  [
    '############',
    '#        * #',
    '#       . @#',
  ...
  // Level 85 - Very Hard (7 boxes, 12x9)
  [
    '############',
    '#      . @ #',
    '#*         #',
  ...
  // Level 86 - Very Hard (7 boxes, 12x10)
  [
    '############',
    '# $ .*     #',
    '#       @  #',
  ...
  // Level 90 - Very Hard (7 boxes, 12x11)
  [
    '############',
    '#          #',
    '#    *  . $#',
  ...
  // Level 100 - Expert (8 boxes, 12x12)
  [
    '############',
    '#@$ .      #',
    '#$ $   .   #',
